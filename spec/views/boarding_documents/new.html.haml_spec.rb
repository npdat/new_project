...
RSpec.describe "boarding_documents/new", type: :view do
  before(:each) do
    assign(:boarding_document, BoardingDocument.new(
      :name => "MyString",
      :gender => false,
      :position => "MyString",
  ...
  it "renders new boarding_document form" do
    render

    assert_select "form[action=?][method=?]", boarding_documents_path, "post" do
